"""blue_line_clean_tra_21478 URL Configuration
...
admin.site.site_header = "Blue Line Clean Tracker"
admin.site.site_title = "Blue Line Clean Tracker Admin Portal"
admin.site.index_title = "Blue Line Clean Tracker Admin"

# swagger
api_info = openapi.Info(
    title="Blue Line Clean Tracker API",
    default_version="v1",
    description="API documentation for Blue Line Clean Tracker App",
)
